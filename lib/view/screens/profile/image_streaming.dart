...
class ImageStreaming extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
                      ...
                      Expanded(
                        child: AspectRatio(
                          ...
                          child: Container(
                            ...
                            clipBehavior: Clip.antiAliasWithSaveLayer,
                            child: Image.file(controller.imageFileList[index]),
                          ),
                        ),
                      ),
                      const SizedBox(
      ...
      bottomSheet: GetBuilder<ImageStreamControllerImp>(builder: (controller)=>controller.imageFileList.isEmpty?SizedBox():CustomButton(text: 'Stop Streaming', onTap: (){
