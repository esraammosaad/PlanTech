                                ...
                                children: [
                                  ...
                                  Column(
                                    ...
                                    children: [
                                      ...
                                      controller.result=="Healthy"?SizedBox():Column(
                                        crossAxisAlignment: CrossAxisAlignment.start,
                                        children: [

                                          SizedBox(height: 16,),
                                          controller.result=="Spot"?CustomHeadingText(themeController: themeController, text: "Treatment of Spot Infection"): controller.result=="Slug"?CustomHeadingText(themeController: themeController, text: "Treatment of Slug Infection"):controller.result=="Powdery"?CustomHeadingText(themeController: themeController, text: "Treatment of Powdery Infection"):controller.result=="Rust"?CustomHeadingText(themeController: themeController, text: "Treatment of Rust Infection"):SizedBox(),
                                          SizedBox(height: 16,),
                                          CustomHeadingTwoText(themeController: themeController, text: "Active constituents:                        \n "),

                                          CustomPointsText(themeController: themeController, text: controller.result=="Spot"?"*Imidacloprid  \n\n *Acetamiprid \n\n *Abamectin 1.8%                            ":controller.result ==
                                              "Slug"
                                              ? "*Proclain \n\n*Chlorpyrifos"
                                              :controller.result ==
                                              "Rust"
                                  ...
                                  ExpansionTile(
                                      ...
                                      title: CustomHeadingText(
                                        themeController: themeController,
                                        text: controller.result == "Healthy"
                                            ? "General Care Tips:"
                                        ...
                                        ExpansionTile(
                                          ...
                                          children: [
                                            CustomPointsText(
                                                themeController:
                                                    themeController,
                                                text: controller.result=="Spot"?"        *Ensure plants receive sufficient sunlight, as many fungal \n          and bacterial diseases thrive in damp, shaded  \n          environments.":controller.result ==
                                                        "Slug"
                                        ...
                                        ExpansionTile(
                                          ...
                                          children: [
                                            CustomPointsText(
                                                themeController:
                                                    themeController,
                                                text: controller.result =="Slug"||controller.result=="Spot"
                                  ...
                                  ExpansionTile(
                                      ...
                                      children: [
                                       ...
                                       controller.result=="Slug"?SizedBox(): ExpansionTile(
                                          title: CustomHeadingTwoText(
                                              themeController: themeController,
                                              text:controller.result ==
                                                          "Healthy"
                                            ...
                                            Column(
                                              ...
                                              children: [
                                                CustomPointsText(
                                                  themeController:
                                                      themeController,
                                                  text:  controller.result=="Spot"?"         *Choose plant varieties that are resistant to \n           spot diseases if they are a recurring issue":controller.result ==
                                                              "Healthy"
                                      ...
                                      children: [
                                        ...
                                        ExpansionTile(
                                          ...
                                          children: [
                                            CustomPointsText(
                                              themeController: themeController,
                                              text: controller.result=="Spot"?"         *Regularly clean up plant debris and fallen leaves,\n           as these can harbor fungal spores.":controller.result == "Slug"
                                        ...
                                        ExpansionTile(
                                          ...
                                          children: [
                                            CustomPointsText(
                                              //
                                              themeController: themeController,
                                              text: controller.result=="Spot"?"         *Frequently inspect your plants for signs of spot diseases\n           and take action at the first sign of infection.":controller.result == "Slug"
                                  ...
                                  CustomMeaningText(
                                    themeController: themeController,
                                    text: controller.result=="Spot"?"Implementing these strategies should help you manage and prevent spot diseases in your plants effectively. If the problem persists, consider consulting a local extension service or a plant specialist for more specific advice.":controller.result == "Slug"
